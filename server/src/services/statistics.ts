...
export class StatisticsService {
  static async getNutritionStatistics(
    ...
    try {
      ...
      const achievementData = await this.getDetailedAchievements(userId, userStats);
  ...
  private static async getDetailedAchievements(userId: string, userStats: UserStats): Promise<Achievement[]> {
    try {
